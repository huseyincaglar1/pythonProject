...
print(type(kelime))
kelime2='Python2'
print(type(kelime2)) #tek tırnak ve çift tırnak kullanmak arasında bir fark yoktur.
sayi = 523456789034567812345678798654322456785423232456432 #python:)
print(type(sayi))
ondalikli_sayi = 3.6
...
#bu deyim çıktımızı tek satıra yazar.
